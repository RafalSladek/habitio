...
const T = {
  en: {
    ...
    cat_focus: "Focus & Flow",
    sug_movement_break: "Movement Break",
    sug_brain_dump: "Brain Dump",
    sug_time_block: "Time-Block a Task",
    sug_single_task: "Single-Task Focus",
    sug_daily_review: "Daily Review",
    focus_mode_on: "Focus Mode: On",
    focus_mode_off: "Focus Mode: Off",
    focus_show_more: "Show {n} more habit(s)",
  ...
  de: {
    ...
    cat_focus: "Fokus & Fluss",
    sug_movement_break: "Bewegungspause",
    sug_brain_dump: "Gedanken entleeren",
    sug_time_block: "Aufgabe einplanen",
    sug_single_task: "Eine Sache fokussieren",
    sug_daily_review: "Tagesrückblick",
    focus_mode_on: "Fokusmodus: An",
    focus_mode_off: "Fokusmodus: Aus",
    focus_show_more: "{n} weitere Gewohnheit(en) anzeigen",
  ...
  pl: {
    ...
    cat_focus: "Fokus i przepływ",
    sug_movement_break: "Przerwa ruchowa",
    sug_brain_dump: "Wyrzut myśli",
    sug_time_block: "Zaplanuj jedno zadanie",
    sug_single_task: "Skupienie na jednym",
    sug_daily_review: "Dzienny przegląd",
    focus_mode_on: "Tryb skupienia: Wł.",
    focus_mode_off: "Tryb skupienia: Wył.",
    focus_show_more: "Pokaż jeszcze {n} nawyk(i)",
  ...
  pt: {
    ...
    cat_focus: "Foco e Fluxo",
    sug_movement_break: "Pausa de Movimento",
    sug_brain_dump: "Descarregar Pensamentos",
    sug_time_block: "Bloquear uma Tarefa",
    sug_single_task: "Foco em Uma Tarefa",
    sug_daily_review: "Revisão Diária",
    focus_mode_on: "Modo Foco: Ativado",
    focus_mode_off: "Modo Foco: Desativado",
    focus_show_more: "Mostrar mais {n} hábito(s)",
  ...
  ru: {
    ...
    cat_focus: "Фокус и поток",
    sug_movement_break: "Двигательная пауза",
    sug_brain_dump: "Разгрузка мыслей",
    sug_time_block: "Распланировать задачу",
    sug_single_task: "Одна задача за раз",
    sug_daily_review: "Ежедневный обзор",
    focus_mode_on: "Режим фокуса: Вкл",
    focus_mode_off: "Режим фокуса: Выкл",
    focus_show_more: "Показать ещё {n} привычк(и)",
  ...
  fr: {
    ...
    cat_focus: "Focus et Fluidité",
    sug_movement_break: "Pause mouvement",
    sug_brain_dump: "Vider son esprit",
    sug_time_block: "Planifier une tâche",
    sug_single_task: "Une tâche à la fois",
    sug_daily_review: "Bilan quotidien",
    focus_mode_on: "Mode focus : Activé",
    focus_mode_off: "Mode focus : Désactivé",
    focus_show_more: "Afficher {n} habitude(s) de plus",
  ...
  hi: {
    ...
    cat_focus: "फ़ोकस और प्रवाह",
    sug_movement_break: "गतिविधि विराम",
    sug_brain_dump: "विचार उतारना",
    sug_time_block: "कार्य-समय निर्धारित करना",
    sug_single_task: "एक काम पर ध्यान",
    sug_daily_review: "दैनिक समीक्षा",
    focus_mode_on: "फ़ोकस मोड: चालू",
    focus_mode_off: "फ़ोकस मोड: बंद",
    focus_show_more: "{n} और आदत(ें) दिखाएं",
  ...
  uk: {
    ...
    cat_focus: "Фокус і потік",
    sug_movement_break: "Рухова пауза",
    sug_brain_dump: "Вивантаження думок",
    sug_time_block: "Заплануй одне завдання",
    sug_single_task: "Одне завдання за раз",
    sug_daily_review: "Щоденний огляд",
    focus_mode_on: "Режим фокусу: Увімкнено",
    focus_mode_off: "Режим фокусу: Вимкнено",
    focus_show_more: "Показати ще {n} звичку(ок)",
  ...
  ar: {
    ...
    cat_focus: "التركيز والتدفق",
    sug_movement_break: "استراحة حركية",
    sug_brain_dump: "تفريغ الأفكار",
    sug_time_block: "تحديد وقت للمهمة",
    sug_single_task: "التركيز على مهمة واحدة",
    sug_daily_review: "المراجعة اليومية",
    focus_mode_on: "وضع التركيز: مفعّل",
    focus_mode_off: "وضع التركيز: معطّل",
    focus_show_more: "عرض {n} عادة إضافية",
  ...
  sq: {
    ...
    cat_focus: "Fokus dhe Rrjedhë",
    sug_movement_break: "Pushim lëvizjeje",
    sug_brain_dump: "Zbraz mendjet",
    sug_time_block: "Planifiko një detyrë",
    sug_single_task: "Fokusimi në një gjë",
    sug_daily_review: "Rishikim ditor",
    focus_mode_on: "Mënyra fokus: Aktiv",
    focus_mode_off: "Mënyra fokus: Çaktiv",
    focus_show_more: "Shfaq {n} zakon(e) të tjera",
  ...
  sr: {
    ...
    cat_focus: "Фокус и ток",
    sug_movement_break: "Покретна пауза",
    sug_brain_dump: "Испражни мисли",
    sug_time_block: "Планирај задатак",
    sug_single_task: "Фокус на један задатак",
    sug_daily_review: "Дневни преглед",
    focus_mode_on: "Режим фокуса: Укључен",
    focus_mode_off: "Режим фокуса: Искључен",
    focus_show_more: "Прикажи још {n} навику(е)",
  ...
  bar: {
    ...
    cat_focus: "Fokus & Flow",
    sug_movement_break: "Bewegungspaus",
    sug_brain_dump: "Gedanken ausleern",
    sug_time_block: "Aufgab einplana",
    sug_single_task: "Eine Sach moan",
    sug_daily_review: "Tagesrückblick",
    focus_mode_on: "Fokusmoodus: Ein",
    focus_mode_off: "Fokusmoodus: Aus",
    focus_show_more: "{n} weitare Gwohnheit(n) zeign",
