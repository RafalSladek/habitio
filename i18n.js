...
const T = {
  en: {
    ...
    lbl_goal: "Goal",
    goal_chip: "Set a quantity goal",
    goal_placeholder_target: "Target (e.g. 100)",
    goal_placeholder_unit: "Unit (e.g. workouts, km, $)",
    tip_goal: "📊 Cumulative goal — counts each check-in toward your total target.",
  ...
  de: {
    ...
    lbl_goal: "Ziel",
    goal_chip: "Mengenziel festlegen",
    goal_placeholder_target: "Zielwert (z.B. 100)",
    goal_placeholder_unit: "Einheit (z.B. Workouts, km, €)",
    tip_goal: "📊 Kumulatives Ziel – jedes Abhaken zählt zum Gesamtziel.",
  ...
  pl: {
    ...
    options_label: "Opcje",
    lbl_goal: "Cel",
    goal_chip: "Ustaw cel ilościowy",
    goal_placeholder_target: "Cel (np. 100)",
    goal_placeholder_unit: "Jednostka (np. treningi, km, zł)",
    tip_goal: "📊 Cel kumulatywny – każde zaznaczenie liczy się do sumy.",
  ...
  pt: {
    ...
    lbl_goal: "Meta",
    goal_chip: "Definir uma meta de quantidade",
    goal_placeholder_target: "Alvo (ex. 100)",
    goal_placeholder_unit: "Unidade (ex. treinos, km, R$)",
    tip_goal: "📊 Meta cumulativa — cada marcação conta para o total.",
  ...
  ru: {
    ...
    lbl_goal: "Цель",
    goal_chip: "Установить количественную цель",
    goal_placeholder_target: "Цель (напр. 100)",
    goal_placeholder_unit: "Единица (напр. тренировки, км, $)",
    tip_goal: "📊 Накопительная цель — каждая отметка засчитывается в общий итог.",
  ...
  fr: {
    ...
    options_label: "Options",
    lbl_goal: "Objectif",
    goal_chip: "Définir un objectif quantitatif",
    goal_placeholder_target: "Cible (ex. 100)",
    goal_placeholder_unit: "Unité (ex. entraînements, km, €)",
    tip_goal: "📊 Objectif cumulatif — chaque validation compte vers le total.",
  ...
  hi: {
    ...
    lbl_goal: "लक्ष्य",
    goal_chip: "मात्रात्मक लक्ष्य निर्धारित करें",
    goal_placeholder_target: "लक्ष्य (जैसे 100)",
    goal_placeholder_unit: "इकाई (जैसे वर्कआउट, किमी, ₹)",
    tip_goal: "📊 संचयी लक्ष्य — प्रत्येक चेक-इन कुल की ओर गिना जाता है।",
  ...
  uk: {
    ...
    lbl_goal: "Ціль",
    goal_chip: "Встановити кількісну ціль",
    goal_placeholder_target: "Ціль (напр. 100)",
    goal_placeholder_unit: "Одиниця (напр. тренування, км, ₴)",
    tip_goal: "📊 Кумулятивна ціль — кожна відмітка зараховується до загального підсумку.",
  ...
  ar: {
    ...
    lbl_goal: "الهدف",
    goal_chip: "تعيين هدف كمي",
    goal_placeholder_target: "الهدف (مثلاً 100)",
    goal_placeholder_unit: "الوحدة (مثلاً تمارين، كم، $)",
    tip_goal: "📊 هدف تراكمي — كل تسجيل يُحسب نحو الإجمالي.",
  ...
  sq: {
    ...
    lbl_goal: "Qëllimi",
    goal_chip: "Vendos një qëllim sasior",
    goal_placeholder_target: "Synimi (p.sh. 100)",
    goal_placeholder_unit: "Njësia (p.sh. stërvitje, km, €)",
    tip_goal: "📊 Qëllim kumulativ — çdo kontrollim numërohet drejt totalit.",
  ...
  sr: {
    ...
    lbl_goal: "Циљ",
    goal_chip: "Поставите квантитативни циљ",
    goal_placeholder_target: "Циљ (нпр. 100)",
    goal_placeholder_unit: "Јединица (нпр. тренинзи, км, €)",
    tip_goal: "📊 Кумулативни циљ — свако означавање се рачуна у укупни збир.",
