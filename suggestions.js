...
const SUGGESTION_DATA = [
  {
    ...
    items: [
      ...
      { nameKey: "sug_strength",       emoji: "💪", cadence: { type: "x_per", count: 3, period: "week" } },
  ...
  },
  {
    ...
    items: [
      ...
      { nameKey: "sug_volunteer",   emoji: "🤝",  cadence: { type: "x_per", count: 1, period: "week" } },
    ],
  },
  {
    catKey: "cat_micro",
  ...
  },
  {
    ...
    items: [
      ...
      { nameKey: "sug_savings",       emoji: "🏦", cadence: { type: "x_per", count: 1, period: "month" } },
