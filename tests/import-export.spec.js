// @ts-check
const { test, expect, STORAGE_VERSION, createState, openClearedApp, goToSettings } = require("./test-helpers");
...
test.describe("export / import", () => {
  ...
  test("import merges new habits and skips duplicates", async ({ page }) => {
    ...
    await expect(page.locator("#import-modal")).not.toHaveClass(/show/);
    const state = await page.evaluate((key) => JSON.parse(localStorage.getItem(key) || "{}"), STORAGE_VERSION);
